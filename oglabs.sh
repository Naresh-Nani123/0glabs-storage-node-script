...
echo -e "${GREEN}👋 ghantamaxpro: Starting 0G Node Setup Script...${NC}"
...
### 10. Done!
echo -e "\n${RED}🎉 ghantamaxpro: Node setup complete!${NC} ${GREEN}Auto-refresh every $INTERVAL_DAYS day(s). You're all set!${NC}"